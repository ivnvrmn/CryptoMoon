...
import com.rmnivnv.cryptomoon.model.PreferencesProvider
...
class AppModule(private val app: MainApp) {
    ...
    @Provides @Singleton fun providePreferencesProvider() = PreferencesProvider(app)
    ...
    @Provides @Singleton fun provideCoinsController(dbController: DBController, prefsProvider: PreferencesProvider) =
            CoinsController(dbController, prefsProvider)
}